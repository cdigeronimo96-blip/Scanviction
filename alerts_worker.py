...
def process_all_alerts():
    ...
    prev_sent=load_json(PREV_SENT,{}); new_sent={}
    ...
    for ticker in SCAN_UNIVERSE:
        ...
        try:
            ...
            detectors=[
                ...
                ("hidden",        "💡 Hidden Movers",          detect_hidden_mover(ticker,q,tech,sent,hot_list)),
                ("sent_flip",     "🌡️ Sentiment Flip",         detect_sentiment_flip(ticker,q,tech,sent,prev_sent)),
                ("breakout",      "⚡📈 Volume Breakout",      detect_breakout(ticker,q,tech)),
                ("fallen_angel",  "📉→📈 Fallen Angels",       detect_fallen_angel(ticker,q,tech,fund)),
                ("smart_money",   "⚡🧲 Smart Money Signal",   detect_smart_money(ticker,q,tech)),
