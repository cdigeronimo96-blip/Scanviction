...
def render_topbar(active=""):
    ...
    if is_authed():
        ...
        # 8 nav items + logo + user + 2 icons is tight at 1200px. Keep the logo
        # column generous enough that the wordmark doesn't overlap button 1,
        # and the nav buttons wide enough to avoid label wrap.
        ratios = [2.3] + [1.05]*len(pages) + [0.9, 0.4, 0.4]
